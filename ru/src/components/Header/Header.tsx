  ...
  return (
    <header ref={headerRef} className={cn(style.header)}>
      ...
      <ul className={style.links}>
        <li>
          <Link href="https://sapfy.pro/">en</Link>
        </li>
        <li>
          <Link
            href="https://www.dropbox.com/scl/fi/wv5qdrwb7tnoe6f7m7h1l/CV_Svetlana-Bautina.pdf?rlkey=am0q13l49o8n2jig0eyv2annv&dl=0"
            target="_blank"
          >
            cv
          </Link>
        ...
        <li>
          <Link href="https://pay.cloudtips.ru/p/d65a7d3a" target="_blank">
            поддержать 🌿
          </Link>
        </li>
      </ul>
